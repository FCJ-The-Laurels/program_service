...
public class StreakController {
    ...
    // Đóng streak (khi hút thuốc hoặc muốn kết thúc thủ công)
    @PostMapping("/break")
    ...
    // Danh sách lần gãy streak (mới -> cũ)
    @GetMapping("/breaks")
